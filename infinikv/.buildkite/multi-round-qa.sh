...
# Start the server
INFINIKV_TRACK_USAGE="false" infinikv_vllm serve mistralai/Mistral-7B-Instruct-v0.2 --disable-log-requests > infinikv_vllm.log 2>&1 &
echo "Waiting for service to start..."
timeout=90  # Timeout duration in seconds
elapsed=0   # Track elapsed time
until grep -q "Uvicorn running on" infinikv_vllm.log; do
