...
# Install infinikv from source
# the infinikv wheel also gives us access to:
# infinikv_server entrypoint
# infinikv_controller entrypoint
cd ../../
if ! command -v nvcc >/dev/null 2>&1; then
  echo "[env-setup] 'nvcc' not found – installing InfiniKV without CUDA extensions"
