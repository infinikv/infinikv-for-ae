...
# differentiate among
# (1) WorkerMsg: push-pull (infinikv->controller)
# (2) ControlMessage: req-reply (controller->infinikv)
# (3) OrchMsg: req-reply (ochestrator->controller)
"""Message from InfiniKV to Controller"""


class WorkerMsg(MsgBase):
    """Message between InfiniKV and Controller"""
...
"""Control Message from Controller to InfiniKV"""


class ControlMsg(MsgBase):
    """Message from Controller to InfiniKV"""
...
class ClearWorkerMsg(ControlMsg):
    """Clear message for a single infinikv worker"""
...
class PinWorkerMsg(ControlMsg):
    """Pin message for a single infinikv worker"""
...
class CompressWorkerMsg(ControlMsg):
    """Compress message for a single infinikv worker"""
...
class MoveWorkerMsg(ControlMsg):
    """Move message for a single infinikv worker"""
...
class HealthWorkerMsg(ControlMsg):
    """Health message for a single infinikv worker"""
...
class CheckFinishWorkerMsg(ControlMsg):
    """Check finish message for a single infinikv worker"""
...
class ControlRetMsg(MsgBase):
    """Return message from InfiniKV to Controller"""
...
class PinWorkerRetMsg(ControlRetMsg):
    """Pin return message for a single infinikv worker"""
...
class CompressWorkerRetMsg(ControlRetMsg):
    """Compress return message for a single infinikv worker"""
...
class MoveWorkerRetMsg(ControlRetMsg):
    """Move return message for a single infinikv worker"""
...
class HealthWorkerRetMsg(ControlRetMsg):
    """Health return message for a single infinikv worker"""
...
class CheckFinishWorkerRetMsg(ControlRetMsg):
    """Check finish return message for a single infinikv worker"""
...
"""Orchestration Message from Ochestrator to InfiniKV"""
