...
from infinikv.utils import CacheEngineKey, _infinikv_nvtx_annotate
...
class ChunkedTokenDatabase(TokenDatabase):
    def __init__(
        self,
        config: Optional[InfiniKVEngineConfig] = None,
        metadata: Optional[InfiniKVEngineMetadata] = None,
    ):
...
class SegmentTokenDatabase(TokenDatabase):
    ...
    def __init__(self, config: InfiniKVEngineConfig, metadata: InfiniKVEngineMetadata):
