...
from infinikv.utils import CacheEngineKey
from infinikv.config import InfiniKVEngineConfig
from infinikv.v1.lookup_server.abstract_server import LookupServerInterface  # noqa: E501
...
class RedisLookupServer(LookupServerInterface):
    def __init__(self, config: InfiniKVEngineConfig):
